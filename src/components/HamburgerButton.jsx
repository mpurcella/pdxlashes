...
const HamburgerButton = ({ isNavOpen, handleIsNavOpen }) => {
    return (
        <button
            type="button"
            className="focus-visible:outline-light-grey md:none flex h-20 w-24 cursor-pointer flex-col justify-around focus-visible:outline-2 focus-visible:outline-offset-4 md:hidden"
